...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item \mathrm{d}_{i1}(x) \lor \dots \lor \mathrm{d}_{im_i}(x) -- it is not stated what this disjunction must equal to, which can be naturally guessed from the infornal explaination to be 1, however. Still, it had better be stated clearly in the formal definition.
